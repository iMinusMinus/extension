...
//        props.put("password", "");
        ...
        s.execute("CREATE TABLE T_TEST (ID BIGINT NOT NULL, BEFORE CLOB, AFTER CLOB, CREATOR VARCHAR(16), creation_date TIMESTAMP, revisor VARCHAR(16), revision_date TIMESTAMP, PRIMARY KEY (id)); COMMENT ON TABLE t_test is  'test'");
